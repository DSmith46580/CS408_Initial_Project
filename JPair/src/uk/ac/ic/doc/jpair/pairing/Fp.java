...
/**
 * This class defines finite fields of characteristics p, where p is a prime
 * number. All the arithmetic operations are done modulo p.
 * 
 * @author Changyu Dong
 * @version 1.0
 */
public class Fp implements Serializable, Field {
	 ...
	 * 
	 * @param p
	 *            the characteristics of this field.
	 * @exception IllegalArgumentException
	 *                if <code>p</code> is not prime.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.ic.doc.jpbc.pairing.Field#add(java.math.BigInteger,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.ic.doc.jpbc.pairing.Field#multiply(java.math.BigInteger,
	 * java.math.BigInteger)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.ic.doc.jpbc.pairing.Field#divide(java.math.BigInteger,
	 * java.math.BigInteger)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.ic.doc.jpbc.pairing.Field#substract(java.math.BigInteger,
	 * java.math.BigInteger)
	 */
	...
	public FieldElement multiply(FieldElement val, int val2) {
		if (!(val instanceof BigInt))
			throw new IllegalArgumentException(
					"The first input must be a BigInt");
		// TODO Auto-generated method stub
		if (val2 < 0)
	...
	/**
	 * @return the square root of val in Fp, or null if the square root does not
	 *         exist.
	 */
	public FieldElement squareRoot(FieldElement val) {
		...
		if (remainder.equals(BigInt.valueOf(5))) {
			...
			BigInt z = (g.multiply(gamma.multiply(i.subtract(BigInt.ONE)))
					.mod(p));
			if (this.square(z).equals(g))
				return z;
			else
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.ic.doc.jpbc.pairing.Field#pow(java.math.BigInt,
	 * java.math.BigInt)
	 */
	public FieldElement pow(FieldElement val, BigInt exp) {
		...
		if (!(val instanceof BigInt))
			throw new IllegalArgumentException(
					"The input FieldElement must be a BigInt");
